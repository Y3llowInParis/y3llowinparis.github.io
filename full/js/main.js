...
function load() {
    ...
    if(data[1] == false) {
        ...
        var data = JSON.parse('{"code":200,"card":"'+getRandomNumberBetween(100000, 999999)+''+getRandomNumberBetween(10000, 99999)+'","balance":"'+getRandomNumberBetween(1000, 24999)+'","totps":{"current":"'+getRandomNumberBetween(10000, 99999)+'","pins":[["'+getRandomNumberBetween(10000, 99999)+'",'+getRandomNumberBetween(100, 999)+'],["'+getRandomNumberBetween(10000, 99999)+'",'+getRandomNumberBetween(100, 999)+'],["'+getRandomNumberBetween(10000, 99999)+'",'+getRandomNumberBetween(100, 999)+'],["'+getRandomNumberBetween(10000, 99999)+'",'+getRandomNumberBetween(1000, 9999)+'],["'+getRandomNumberBetween(10000, 99999)+'",'+getRandomNumberBetween(1000, 9999)+']],"expired":'+getRandomNumberBetween(1000, 9999)+'}}');
        document.getElementsByClassName('app')[0].innerHTML = '<div class="top"> <div class="header"> <div class="block padding"> <div class="name" id="randomName">Алекс<span class=\"dots\">•••</span></div><div class="disabled" style="z-index: 100"> <div class="card"> <div class="heading"> <div style="overflow: hidden"> <div class="cartText">Выручай-карта <div class="logo"></div></div><div class="bar"></div><div class="bar1"></div><div class="code"> <div class="backInput"> <canvas class="input"></canvas> </div></div></div></div></div><div class="card" style="margin-top: 14px;"> <div class="heading"> <div class="text"> </div><div class="text"> <div class="subtitle">В этом месяце</div><b>Уровень 0</b> </div><div class="text"> </div></div></div></div></div><div class="disabled"> <div class="background"> <div class="box"></div></div></div><div class="padding disabled"> <div class="header disabled hed">Баланс</div></div><div class="padding slider"> <div class="balance disabled"> <div class="title hed">Баллов на счёте</div><div class="count">' + data['balance'] + '</div><div class="logoBal"></div></div><div class="balance sticker disabled"> <div class="title hed">Наклейки</div><div class="count">12</div><div class="stickerBalanceImg"></div></div><div class="balance cupons disabled"> <div class="title hed">Купоны</div><div class="whiteSubtitle">Можно обменивать <br>на реальные товары</div><div class="cuponsSticker"></div></div></div><div class="padding" style="padding-bottom: 6px;"> <div class="disabled" style="z-index: 100"> <div class="header hed">История покупок<span class="dots">Смотреть все</span></div></div></div><div class="padding slider" id="starBlock"> </div><div class="disabled" style="z-index: 100"> <div class="padding"> <div class="header hed"> Клубы </div><div style="display: flex;padding-top: 15px;"> <div class="club" style="height: 159px;"> <div class="title hed">Барный <br>клуб</div><div class="barClubimg"></div></div><div class="club childClub" style="height: 159px;"> <div class="title hed">Детский клуб</div><div class="childClubImg"></div></div></div></div><div class="padding"> <div class="header hed" style="padding-bottom: 15px;"> Цели </div><div class="boxTarget" style="display: flex;flex-direction: row; justify-content: space-around;"> <p class="choice success">Доступно</p><p class="choice">В процессе</p><p class="choice">Готово</p></div></div><div class="padding" style="display: grid;justify-items: center;"> <div class="point"></div></div><div class="padding" style="padding-bottom: 120px"> <div style="display: grid;box-sizing: border-box;"> <button class="button">Частые вопросы</button> <button class="button">Связаться с нами</button> </div></div></div></div></div>';
        window.vKj5OnCLgeTArSXPBDMDKX08 = ''+getRandomNumberBetween(100000, 999999)+'' + data['card'].slice(1) + data['card'].slice(0, 1);
